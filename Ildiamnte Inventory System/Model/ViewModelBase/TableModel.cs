...
namespace Ildiamnte_Inventory_System.Model
{
    public abstract class TableModel<Entity> : ListModel<Entity>
    {
        ...
        public string newButtonContent { get { return string.Format("Nuovo {0}", ItemName); } }
        public string editButtonContent { get { return string.Format("Modificare {0}", ItemName); } }
        public string deleteButtonContent { get { return string.Format("Elimina {0}", ItemName); } }
