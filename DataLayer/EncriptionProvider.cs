...
namespace DataLayer
{
    public class EncriptionProvider
    {
        ...
        /// <summary>
        /// Encrypts a string with salted SHA hashing.
        /// </summary>
        ...
        /// <summary>
        /// Checks if a plainText is the same as the original text which was encrypted to the hashValue.
        /// </summary>
        /// <param name="plainText">Original text.</param>
        /// <param name="hashValue">Encrypted text.</param>
